// Icon SVG bodies + an <Icon> Vue component. The renderer used to walk
// the DOM hydrating [data-icon] markers; with Vue we instead drop an
// <Icon> wherever an icon is needed.
